...
<center><table align="center" width="90%" class="form_reg">
        ...
        <tr>
            <td align="center"><label>Precio<br>(En dólares)</label></th>
                <td align="center"><input type="number" id="precio" name="precio" value="<?php echo $consulta[3] ?>"><pre>
                </pre></td>
        </tr>

            <input style="display: none;" type="text" id="nombre_empresa" name="nombre_empresa" value="<?php echo $_SESSION['username'] ?>">
