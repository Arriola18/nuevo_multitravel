...
<html>
    ...
    <body>
        ...
        ?>
        <script type="text/javascript">
            document.getElementById("icono_2").style.background = "#c7c7c7";
        </script>
        </div>
        <?php
        ...
        <div id="principal">
            ...
            while($fila=$resultado->fetch_assoc()) {
                ...
                echo "<th align='center' colspan='3'><a style='text-decoration: none;' href='../user1/servicio.php?id_servicio=".$fila['id_servicio']."'><font size='4.5' color='0d1f47'>"; echo $fila['nombre_servicio']; echo "</font></a></th>"; 
                echo "</thead>";
                ...
                echo "</tr>";
                echo "<tr class='alto_lim'>";
                echo "<td rowspan='2' align='center'><font face='arial'>Precio: "; echo $fila['precio']; echo "</font></td>";
