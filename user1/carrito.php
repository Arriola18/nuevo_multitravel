...
<html>
    ...
    <body>
        ...
        ?>
            <form method="post" action="validar_pedido.php"><table>
                <tr>
                <div id="smart-button-container">
    <div style="text-align: center"><label for="description">MULTITRAVEL_SERVICES <b><?php echo $consulta[1]; ?></b></div>
      <p id="descriptionError" style="visibility: hidden; color:red; text-align: center;">Please enter a description</p>
    <div style="text-align: center"><label for="amount">PRECIO </label><input name="amountInput" type="text" id="amount" value="<?php echo $consulta[3] ?>" ><span><p class="m-0 text-center text-white"></p></span></div>
